import {t as e} from "./CBOYJfno.js";
var t = e((e => {
    e.byteLength = c,
    e.toByteArray = u,
    e.fromByteArray = p;
    for (var t = [], n = [], r = typeof Uint8Array < `u` ? Uint8Array : Array, i = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/`, a = 0, o = i.length; a < o; ++a)
        t[a] = i[a],
        n[i.charCodeAt(a)] = a;
    n[45] = 62,
    n[95] = 63;
    ...
    function u(e) {
        ...
        for (f = 0; f < d; f += 4)
            t = n[e.charCodeAt(f)] << 18 | n[e.charCodeAt(f + 1)] << 12 | n[e.charCodeAt(f + 2)] << 6 | n[e.charCodeAt(f + 3)],
            c[u++] = t >> 16 & 255,
            c[u++] = t >> 8 & 255,
            c[u++] = t & 255;
        return o === 2 && (t = n[e.charCodeAt(f)] << 2 | n[e.charCodeAt(f + 1)] >> 4,
        c[u++] = t & 255),
        o === 1 && (t = n[e.charCodeAt(f)] << 10 | n[e.charCodeAt(f + 1)] << 4 | n[e.charCodeAt(f + 2)] >> 2,
        c[u++] = t >> 8 & 255,
        c[u++] = t & 255),
        c
    }
    ...
    function p(e) {
        ...
        return i === 1 ? (n = e[r - 1],
        a.push(t[n >> 2] + t[n << 4 & 63] + `==`)) : i === 2 && (n = (e[r - 2] << 8) + e[r - 1],
  ...
  , r = e((e => {
    ...
    function f(e, t, n) {
        return d(e),
        e <= 0 || t === void 0 ? c(e) : typeof n == `string` ? c(e).fill(t, n) : c(e).fill(t)
    }
    ...
    function g(e, t, n) {
        ...
        let r;
        return r = t === void 0 && n === void 0 ? new Uint8Array(e) : n === void 0 ? new Uint8Array(e,t) : new Uint8Array(e,t,n),
    ...
    function _(e) {
        ...
        if (e.length !== void 0)
            return typeof e.length != `number` || Q(e.length) ? c(0) : h(e);
    ...
    l.prototype.toString = function() {
        let e = this.length;
        return e === 0 ? `` : arguments.length === 0 ? E(this, 0, e) : x.apply(this, arguments)
    }
    ,
    ...
    function C(e, t, n, r, i) {
        ...
        n >= e.length) {
            ...
            if (i)
                ...
                return -1;
        if (typeof t == `string` && (t = l.from(t, r)),
        l.isBuffer(t))
            return t.length === 0 ? -1 : w(e, t, n, r, i);
        if (typeof t == `number`)
            return t &= 255,
            typeof Uint8Array.prototype.indexOf == `function` ? i ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : w(e, [t], n, r, i);
    ...
    function ae(e, t, n, r) {
        return X(ce(t, e.length - n), e, n, r)
    }
    ...
    ,
    l.prototype.readBigUInt64LE = $(function(e) {
        e >>>= 0,
        G(e, `offset`);
        let t = this[e]
          , n = this[e + 7];
    ...
    l.prototype.readBigUInt64BE = $(function(e) {
        e >>>= 0,
        G(e, `offset`);
        let t = this[e]
          , n = this[e + 7];
    ...
    ,
    l.prototype.readBigInt64LE = $(function(e) {
        e >>>= 0,
        G(e, `offset`);
        let t = this[e]
          , n = this[e + 7];
    ...
    l.prototype.readBigInt64BE = $(function(e) {
        e >>>= 0,
        G(e, `offset`);
        let t = this[e]
          , n = this[e + 7];
    ...
    l.prototype.writeBigUInt64LE = $(function(e, t=0) {
        return F(this, e, t, BigInt(0), BigInt(`0xffffffffffffffff`))
    }),
    l.prototype.writeBigUInt64BE = $(function(e, t=0) {
    ...
    ,
    l.prototype.writeBigInt64LE = $(function(e, t=0) {
        return F(this, e, t, -BigInt(`0x8000000000000000`), BigInt(`0x7fffffffffffffff`))
    }),
    l.prototype.writeBigInt64BE = $(function(e, t=0) {
    ...
    function R(e, t, n, r, a) {
        return t = +t,
        n >>>= 0,
        a || L(e, t, n, 4, 34028234663852886e22, -34028234663852886e22),
    ...
    function z(e, t, n, r, a) {
        return t = +t,
        n >>>= 0,
        a || L(e, t, n, 8, 17976931348623157e292, -17976931348623157e292),
    ...
    l.prototype.copy = function(e, t, n, r) {
        ...
        let i = r - n;
        return this === e && typeof Uint8Array.prototype.copyWithin == `function` ? this.copyWithin(t, n, r) : Uint8Array.prototype.set.call(e, this.subarray(n, r), t),
        i
    }
    ,
    ...
    V(`ERR_OUT_OF_RANGE`, function(e, t, n) {
        let r = `The value of "${e}" is out of range.`
          , i = n;
        return Number.isInteger(n) && Math.abs(n) > 2 ** 32 ? i = H(String(n)) : typeof n == `bigint` && (i = String(n),
        (n > BigInt(2) ** BigInt(32) || n < -(BigInt(2) ** BigInt(32))) && (i = H(i)),
        i += `n`),
    ...
    function U(e, t, n) {
        G(t, `offset`),
        (e[t] === void 0 || e[t + n] === void 0) && K(t, e.length - (n + 1))
    }
    ...
    function K(e, t, n) {
        throw Math.floor(e) === e ? t < 0 ? new B.ERR_BUFFER_OUT_OF_BOUNDS : new B.ERR_OUT_OF_RANGE(n || `offset`,`>= ${+!!n} and <= ${t}`,e) : (G(e, n),
